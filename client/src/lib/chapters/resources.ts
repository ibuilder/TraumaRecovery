  ...
  subchapters: [
    {
      ...
      slug: "expert-videos",
      order: 1,
      content: `# Expert Video Playlists

Curated video collections from leading trauma experts organized by topic.

## Dr. Gabor Maté Video Collection
...
1. **What Is Trauma?** - Introduction to Dr. Maté's definition
2. **Trauma and the Body** - How trauma affects physical health
3. **Trauma and Addiction** - The connection between early wounds and substance use
4. **Compassionate Inquiry** - Dr. Maté's therapeutic approach
5. **Healing Trauma** - Pathways to recovery

### Podcast Appearances (Video Available)

**2024-2025 Appearances:**

| Podcast | Topic | Key Takeaways |
|---------|-------|---------------|
| Jay Shetty | Guilt, Fear, Shame | Authenticity, processing fear, life regrets |
| Mel Robbins | Healing From Trauma | Practical steps for trauma recovery |
...
## Dr. Bessel van der Kolk Video Collection

### Core Lectures

**"The Body Keeps the Score" Lecture:**
- Overview of trauma's impact on brain and body
- Why traditional talk therapy isn't enough
- Introduction to body-based interventions
- Available on multiple platforms

**"Understanding Trauma" (Psychotherapy.net):**
- Comprehensive interview format
- Covers treatment approaches
- Discusses complex trauma vs. single-incident
- Professional-level content

**"When Is It Trauma?" (Psychotherapy Networker):**
- Defining what qualifies as trauma
- How trauma overwhelms the nervous system
- Differential diagnosis considerations

### Treatment Approach Videos

**Body-Based Interventions:**
- Yoga for trauma recovery
- Theater and movement therapy
- EMDR demonstrations
...
1. **Dysfunctional Family Roles** - Understanding family system dynamics
2. **Inner Child Healing** - Practical exercises for self-healing
3. **Boundaries** - How to set and maintain healthy limits
4. **Emotional Flashbacks** - Understanding and managing triggers

---

## Crappy Childhood Fairy (Anna Runkle)

Anna Runkle, founder of Crappy Childhood Fairy, focuses on Complex PTSD recovery with practical daily techniques.
...
|--------|-------|----------|
| Signs of CPTSD | Recognition and validation | 10+ videos |
| Daily Practice | Core healing technique | 20+ videos |
| Relationships | Dating and attachment | 15+ videos |
| Limerence | Intense romantic obsession | 10+ videos |

---

## Therapy in a Nutshell (Emma McAdam)

Licensed therapist Emma McAdam creates accessible mental health education videos.

### Trauma-Related Playlists
...
1. **Take Notes** - Write down key insights that resonate
2. **Pause and Reflect** - Stop videos to process emotional content
3. **Practice Exercises** - Apply techniques demonstrated
...
- Process Addictions
- Eating Disorders (dedicated Oak House program)
...
|--------------|-------------|
| Individual Therapy | One-on-one sessions with licensed therapist |
| Group Therapy | Twice daily group sessions |
...
| Trauma & PTSD | Complex trauma, PTSD |
| Addiction | Substance use disorders |
| Pain Recovery | Chronic pain management |
